...
#New_Verifie_User"""
        ...
        await protect_content = True if user_id == 'm.from_user_id' else True, m.reply_photo(photo="https://telegra.ph/file/650c8b857763f8d96892c.jpg", caption="he how are you", #protect_content = True if user_id == 'm.from_user_id' else True,#coption=(MALIK2.format(message.from_user.mention)),
