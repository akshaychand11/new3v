...
async def req_grp_results(bot, msg):
    ...
    await msg.reply_text(f"<b>Heyyy!!! {user}\n\nɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ᴇᴀʀɴ ᴍᴏɴᴇʏ ғᴏʀᴍ sᴛᴏᴄᴋ ᴍᴀʀᴋᴇᴛ (शेयर बाजार) ᴛʜᴇɴ ᴊᴏɪɴ ɴᴏᴡ 💜 & ɢᴇᴛ ᴜᴘᴛᴏ 𝟷𝟶𝟶+ ᴄᴏᴜʀsᴇ 🆓ᴏғ sᴛᴏᴄᴋ ᴍᴀʀᴋᴇᴛ ғᴏʀ ғʀᴇᴇ 🆓\n🅹🅾🅸🅽 🅽🅾🆆 👇</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔸 💹 🇸‌ᴛᴏᴄᴋ ɢʀᴏᴜᴘ 💹 🔸",url="https://t.me/+YJjpnCe3Wiw1Yjdl"),]]),parse_mode='HTML'),
    k = await manual_filters(client, message)
    if k == False:
        await auto_filter(client, message)
