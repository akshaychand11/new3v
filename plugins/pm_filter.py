...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import REQ_GRP2, LOG_CHANNEL, MAINTENANCE_MODE, MBGH, REQ_GRP, TUTORIAL_LINK, ADMINS, AUTH_CHANNEL, VIDEO_VD, AUTH_USERS, M_NT_F, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
...
@Client.on_message(filters.group & filters.text & filters.incoming &~ filters.chat(REQ_GRP2))
async def give_filter(client, message):
