        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('♻️ 𝐉𝐨𝐢𝐧 𝙂𝙧𝙤𝙪𝙥 ', url=malik.j_group)],[InlineKeyboardButton("♻️ 𝐉𝐨𝐢𝐧 𝙂𝙧𝙤𝙪𝙥 ", url=malik.j_group2),]]),parse_mode=enums.ParseMode.HTML)
